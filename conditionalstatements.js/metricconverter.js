...
function main(num, input, output) {
    ...
    if (input == "m") {
        if (output == "mm") {
            ...
            console.log("Already in desired metric unit");
        }
    } else if (input == "mm") {
        if (output == "m") {
        ...
        if (output == "mm") {
            ...
            converteUnit = num * (1 / 0.000621371192) * 100;
            console.log(convertedUnit.toFixed(10));
        } else if (output == "m") {
        ...
        if (output == "mm") {
            ...
            converteUnit = num * (1 / 39.3700787) * 100;
            console.log(convertedUnit.toFixed(10));
        } else if (output == "m") {
        ...
        if (output == "mm") {
            ...
            converteUnit = num * (1 / 3.2808399) * 100;
            console.log(convertedUnit.toFixed(10));
        } else if (output == "mi") {
            ...
            if (output == "mm") {
                ...
                converteUnit = num * (1 / 1.0936133) * 100;
                console.log(convertedUnit.toFixed(10));
            } else if (output == "mi") {
        ...
        console.log("Please choose one of the following currencies: m, mm, cm, mi, in, km ft, yd");
    }
